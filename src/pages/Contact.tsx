      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 pt-28 pb-24">
        ...
        >
          ...
          <CharReveal
            ...
            className="max-w-9xl text-3xl font-bold tracking-[-0.04em] text-foreground sm:text-5xl lg:text-5xl xl:text-7xl mt-8 leading-[0.95] uppercase"
            immediate
            delay={0}
            stagger={0.028}
            lineGap="mt-6"
          ...
          <motion.p
            ...
            className="mt-10 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg text-center mx-auto"
          >
        ...
        >
          <motion.section
            variants={fadeUpVariants}
            className="rounded-2xl border border-black/10 bg-card p-10 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.16)]"
          >
            <div className="grid gap-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    rows={6}
                    className="mt-3 min-h-[180px] w-full rounded-xl border border-input bg-transparent px-4 py-4 text-base text-foreground outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
          ...
          <motion.aside
            variants={fadeUpVariants}
            className="space-y-6 rounded-2xl border border-black/10 bg-card p-10 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.16)]"
          >
        ...
        >
          {[
            ...
            <motion.div
              key={item.title}
              variants={fadeUpVariants}
              className="rounded-2xl border border-black/10 bg-card p-7 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.16)] transition hover:-translate-y-1 hover:border-white/20"
            >
