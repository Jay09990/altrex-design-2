            ...
            return (
              <motion.div key={solution.slug} variants={fadeUpVariants}>
                <Link
                  ...
                  className="group relative flex h-full flex-col rounded-2xl border border-white/10 bg-[var(--bg-surface)] p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-[var(--bg-surface)]/80 backdrop-blur-sm"
                >
                  {/* Icon */}
